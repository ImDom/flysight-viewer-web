var g1=Object.defineProperty;var m1=(i,e,a)=>e in i?g1(i,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):i[e]=a;var u=(i,e,a)=>(m1(i,typeof e!="symbol"?e+"":e,a),a);import{g as q,P as y1,w as B,u as i1,r as Z,L as Y,S as X,O as K,G as v1,a as J,b as x1,c as A1,d as Q,e as S1,j as y,f as N,h as M1,i as b1,k as w1,l as D1,m as C1,C as M,p as R1,n as E1,o as L1,q as k,s as z1,t as z,W as s1,v as I1,x as O1,B as N1,R as _1,y as F1,z as V1}from"./vendor.342bd406.js";const P1=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const p of r.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&t(p)}).observe(document,{childList:!0,subtree:!0});function a(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerpolicy&&(r.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?r.credentials="include":n.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function t(n){if(n.ep)return;n.ep=!0;const r=a(n);fetch(n.href,r)}};P1();const F=9.80665,G1=101325,j=.0065,e1=288.15,t1=.0289644,n1=8.31447;class D{constructor(e){u(this,"dateTime");u(this,"hasGeodetic");u(this,"lat");u(this,"lon");u(this,"hMSL");u(this,"velN");u(this,"velE");u(this,"velD");u(this,"hAcc");u(this,"vAcc");u(this,"sAcc");u(this,"heading");u(this,"cAcc");u(this,"numSV");u(this,"t");u(this,"x");u(this,"y");u(this,"z");u(this,"dist2D");u(this,"dist3D");u(this,"curv");u(this,"accel");u(this,"ax");u(this,"ay");u(this,"az");u(this,"amag");u(this,"lift");u(this,"drag");u(this,"vx");u(this,"vy");u(this,"theta");u(this,"omega");this.raw=e,this.raw&&(this.hasGeodetic=!0,this.dateTime=new Date(this.raw.time),this.lat=parseFloat(this.raw.lat),this.lon=parseFloat(this.raw.lon),this.hMSL=parseFloat(this.raw.hMSL),this.velN=parseFloat(this.raw.velN),this.velE=parseFloat(this.raw.velE),this.velD=parseFloat(this.raw.velD),this.hAcc=parseFloat(this.raw.hAcc),this.vAcc=parseFloat(this.raw.vAcc),this.sAcc=parseFloat(this.raw.sAcc),this.numSV=parseInt(this.raw.numSV,10))}get elevation(){return this.z}get northSpeed(){return this.vy}get eastSpeed(){return this.vx}get northSpeedRaw(){return this.velN}get eastSpeedRaw(){return this.velE}get verticalSpeed(){return this.velD}get horizontalSpeed(){return Math.sqrt(this.vx*this.vx+this.vy*this.vy)}get totalSpeed(){return Math.sqrt(this.vx*this.vx+this.vy*this.vy+this.velD*this.velD)}get diveAngle(){return Math.atan2(this.velD,Math.sqrt(this.vx*this.vx+this.vy*this.vy))/Math.PI*180}get curvature(){return this.curv}get glideRatio(){return this.velD!=0?Math.sqrt(this.vx*this.vx+this.vy*this.vy)/this.velD:0}get horizontalAccuracy(){return this.hAcc}get verticalAccuracy(){return this.vAcc}get speedAccuracy(){return this.sAcc}get numberOfSatellites(){return this.numSV}get time(){return this.t}get distance2D(){return this.dist2D}get distance3D(){return this.dist3D}get acceleration(){return this.accel}get accForward(){return this.ax}get accRight(){return this.ay}get accDown(){return this.az}get accMagnitude(){return this.amag}get totalEnergy(){const e=this.totalSpeed;return e*e/2+F*this.elevation}get energyRate(){return this.totalSpeed*this.acceleration-F*this.verticalSpeed}get liftCoefficient(){return this.lift}get dragCoefficient(){return this.drag}get course(){return this.theta}get courseRate(){return this.omega}get courseAccuracy(){return this.cAcc}static interpolate(e,a,t){const n=new D,r=e.dateTime.getTime(),p=a.dateTime.getTime();return n.dateTime=new Date,n.dateTime.setTime(r+t*(p-r)),n.hasGeodetic=e.hasGeodetic&&a.hasGeodetic,n.lat=e.lat+t*(a.lat-e.lat),n.lon=e.lon+t*(a.lon-e.lon),n.hMSL=e.hMSL+t*(a.hMSL-e.hMSL),n.velN=e.velN+t*(a.velN-e.velN),n.velE=e.velE+t*(a.velE-e.velE),n.velD=e.velD+t*(a.velD-e.velD),n.hAcc=e.hAcc+t*(a.hAcc-e.hAcc),n.vAcc=e.vAcc+t*(a.vAcc-e.vAcc),n.sAcc=e.sAcc+t*(a.sAcc-e.sAcc),t<.5?n.numSV=e.numSV:n.numSV=a.numSV,n.t=e.t+t*(a.t-e.t),n.x=e.x+t*(a.x-e.x),n.y=e.y+t*(a.y-e.y),n.z=e.z+t*(a.z-e.z),n.dist2D=e.dist2D+t*(a.dist2D-e.dist2D),n.dist3D=e.dist3D+t*(a.dist3D-e.dist3D),n.curv=e.curv+t*(a.curv-e.curv),n.accel=e.accel+t*(a.accel-e.accel),n.ax=e.ax+t*(a.ax-e.ax),n.ay=e.ay+t*(a.ay-e.ay),n.az=e.az+t*(a.az-e.az),n.amag=e.amag+t*(a.amag-e.amag),n.lift=e.lift+t*(a.lift-e.lift),n.drag=e.drag+t*(a.drag-e.drag),n.heading=e.heading+t*(a.heading-e.heading),n.cAcc=e.cAcc+t*(a.cAcc-e.cAcc),n.vx=e.vx+t*(a.vx-e.vx),n.vy=e.vy+t*(a.vy-e.vy),n.theta=e.theta+t*(a.theta-e.theta),n.omega=e.omega+t*(a.omega-e.omega),n}static getDistance(e,a,t){if(!t&&e.hasGeodetic&&a.hasGeodetic)return q([e.lat,e.lon],[a.lat,a.lon]);{const n=a.x-e.x,r=a.y-e.y;return Math.sqrt(n*n+r*r)}}static getBearing(e,a,t){if(!t&&e.hasGeodetic&&a.hasGeodetic){const n=q([e.lat,0],[a.lat,0]);return q([0,e.lon],[0,a.lon]),n/180*Math.PI}else{const n=a.x-e.x,r=a.y-e.y;return Math.atan2(n,r)}}}class q1{constructor(){u(this,"options",{groundReference:0,fixedReference:0,windAdjustment:!1,windE:0,windN:0,mass:90,planformArea:2});u(this,"wind");u(this,"ground");u(this,"course");u(this,"datapoints",[])}importFromText(e){y1.parse(e,{header:!0,skipEmptyLines:!0}).data.forEach(t=>{!t.time||this.datapoints.push(new D(t))}),this.initTime(),this.initAltitude(),this.initAcceleration(),this.updateVelocity(!0),console.log("Track:",this)}initTime(){const e=this.datapoints[0].dateTime.getTime();this.datapoints.forEach((a,t)=>{const n=a.dateTime.getTime();a.t=(n-e)/1e3})}initExit(){}initAltitude(){let e;this.ground?e=this.ground:this.options.groundReference===0?e=this.datapoints[this.datapoints.length-1].hMSL:e=this.options.fixedReference,this.ground=e,this.datapoints.forEach((a,t)=>{a.z=a.hMSL-e})}initAcceleration(){this.datapoints.forEach((e,a)=>{const t=this.getSlope(a,e.northSpeedRaw),n=this.getSlope(a,e.eastSpeedRaw),r=this.getSlope(a,e.verticalSpeed),p=Math.sqrt(e.velN*e.velN+e.velE*e.velE);e.ax=(t*e.velN+n*e.velE)/p,e.ay=(n*e.velN-t*e.velE)/p,e.az=r,e.amag=Math.sqrt(t*t+n*n+r*r)})}initAerodynamics(){this.datapoints.forEach((e,a)=>{let t=this.getSlope(a,e.northSpeed),n=this.getSlope(a,e.eastSpeed),r=this.getSlope(a,e.verticalSpeed);r-=F;const p=e.totalSpeed,f=(t*e.vy+n*e.vx+r*e.velD)/p,T=f*e.vy/p,l=f*e.vx/p,o=f*e.velD/p,h=Math.sqrt(T*T+l*l+o*o),g=t-T,m=n-l,v=r-o,x=Math.sqrt(g*g+m*m+v*v),A=G1*Math.pow(1-j*e.hMSL/e1,F*t1/n1/j),S=e1-j*e.hMSL,b=A/(n1/t1)/S*p*p/2;e.lift=this.options.mass*x/b/this.options.planformArea,e.drag=this.options.mass*h/b/this.options.planformArea})}updateVelocity(e=!1){if(this.datapoints.length===0)return;const a=this.getWind();if(e&&(this.wind=a),this.options.windAdjustment){for(let l=0;l<this.datapoints.length;++l){const o=this.interpolateDataT(0),h=this.datapoints[l],g=D.getDistance(o,h,this.options.windAdjustment),m=D.getBearing(o,h,this.options.windAdjustment);h.x=g*Math.sin(m)-a.east*h.t,h.y=g*Math.cos(m)-a.north*h.t}for(let l=0;l<this.datapoints.length;++l){const o=this.datapoints[l];o.vx=o.velE-a.east,o.vy=o.velN-a.north}}else{for(let l=0;l<this.datapoints.length;++l){const o=this.interpolateDataT(0),h=this.datapoints[l],g=D.getDistance(o,h,this.options.windAdjustment),m=D.getBearing(o,h,this.options.windAdjustment);h.x=g*Math.sin(m),h.y=g*Math.cos(m)}for(let l=0;l<this.datapoints.length;++l){const o=this.datapoints[l];o.vx=o.velE,o.vy=o.velN}}let t=0,n=0;for(let l=0;l<this.datapoints.length;++l){const o=this.datapoints[l];if(l>0){const h=this.datapoints[l-1],g=o.x-h.x,m=o.y-h.y,v=Math.sqrt(g*g+m*m),x=o.hMSL-h.hMSL;t+=v,n+=Math.sqrt(v*v+x*x)}o.dist2D=t,o.dist3D=n}const r=this.interpolateDataT(0);for(let l=0;l<this.datapoints.length;++l){const o=this.datapoints[l];o.x-=r.x,o.y-=r.y,o.dist2D-=r.dist2D,o.dist3D-=r.dist3D}let p;this.course?p=this.course:p=0,e&&(this.course=p);let f=0,T=!0;for(let l=0;l<this.datapoints.length;++l){const o=this.datapoints[l];o.heading=Math.atan2(o.vx,o.vy)/Math.PI*180;const h=o.totalSpeed;if(h!=0?o.cAcc=o.sAcc/h:o.cAcc=0,!T){for(;o.heading<f-180;)o.heading+=360;for(;o.heading>=f+180;)o.heading-=360}o.theta=o.heading-p,T=!1,f=o.heading}for(let l=0;l<this.datapoints.length;++l){const o=this.datapoints[l];o.curv=this.getSlope(l,o.diveAngle),o.accel=this.getSlope(l,o.totalSpeed),o.omega=this.getSlope(l,o.course)}this.initAerodynamics()}getSlope(e,a){const t=Math.max(0,e-4),n=Math.min(this.datapoints.length-1,e+4);let r=0,p=0,f=0,T=0;for(let o=t;o<=n;++o){const h=this.datapoints[o],g=a;r+=h.t,p+=g,f+=h.t*h.t,T+=h.t*g}const l=n-t+1;return(T-r*p/l)/(f-r*r/l)}getWind(){return this.wind?this.wind:{east:this.options.windE,north:this.options.windN}}getWindSpeedDirection(){const e=this.getWind(),a=Math.sqrt(e.east*e.east+e.north*e.north);let t=Math.atan2(-e.east,-e.north)/Math.PI;return t<0&&(t+=360),{speed:a,direction:t}}interpolateDataT(e){const a=this.findIndexBelowT(e),t=this.findIndexAboveT(e);if(a<0)return this.datapoints[0];if(t>=this.datapoints.length)return this.datapoints[this.datapoints.length-1];{const n=this.datapoints[a],r=this.datapoints[t];return D.interpolate(n,r,(e-n.t)/(r.t-n.t))}}findIndexBelowT(e){let a=-1,t=this.datapoints.length;for(;a+1!==t;){const n=Math.floor((a+t)/2);this.datapoints[n].t<e?a=n:t=n}return a}findIndexAboveT(e){let a=-1,t=this.datapoints.length;for(;a+1!==t;){const n=Math.ceil((a+t)/2);this.datapoints[n].t>e?t=n:a=n}return t}}const j1=B(({track:i,activeDatapointIndex:e})=>{const a=i1(),t=Z.exports.useRef(null),n=Z.exports.useRef(),r=Z.exports.useRef();function p(f){var T,l;(l=(T=r.current)==null?void 0:T.getSource())==null||l.forEachFeature(o=>{const h=f?N([f.lon,f.lat]):[0,0];o.getGeometry().setCoordinates(h)})}return Z.exports.useEffect(()=>(!r.current&&n.current&&(console.log("Initializing marker"),r.current=new Y({source:new X({features:[new K({geometry:new v1([0,0]),name:"Point"})]})}),r.current.setStyle(new J({image:new x1({fill:new A1({color:"#000000"}),stroke:new Q({color:"#ff0000",width:2}),radius:3})})),n.current.addLayer(r.current)),()=>{var f;(f=r.current)==null||f.dispose(),r.current=void 0}),[n.current]),Z.exports.useEffect(()=>{if(r.current&&n.current&&e){const f=i.datapoints[e];p(f)}},[e]),S1(()=>{var g,m;if(n.current||!t.current)return;console.info("Initializing map");const f=i.datapoints[0];n.current=new M1({target:t.current,layers:[new b1({source:new w1({url:"https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",maxZoom:19,attributions:"ArcGIS"})})],view:new D1({center:N([f.lon,f.lat]),zoom:14})});var T=[new J({stroke:new Q({color:"#d12710",width:2})})],l=new Y({source:new X({features:i.datapoints.map((v,x)=>{let A=i.datapoints[x+1];A||(A=v);var S=N([v.lon,v.lat]),R=N([A.lon,A.lat]);const b=new K({geometry:new C1([S,R]),name:"Line"});return b.setId(x),b})})});l.setStyle(T),n.current.addLayer(l);const o=(g=l.getSource())==null?void 0:g.getExtent();o&&n.current.getView().fit(o,{padding:[50,50,50,50]});const h=v=>{var x;v.dragging||(x=n.current)==null||x.forEachFeatureAtPixel(v.pixel,(A,S)=>{if(!S)return!0;const R=A.getId();if(typeof R=="number"){const b=i.datapoints[R];return p(b),!!b}},{hitTolerance:10,layerFilter:A=>A===l})};return n.current.on("pointermove",h),(m=n.current)==null||m.on("singleclick",h),a(),()=>{var v;(v=n.current)==null||v.dispose(),n.current=void 0}}),y("div",{style:{width:"100%",height:"100%"},ref:t})});var C=(i=>(i[i.Metric=0]="Metric",i[i.Imperial=1]="Imperial",i))(C||{});const $1="_Chart_1q3ui_1";var B1={Chart:$1};function W1(i){return i*3.28084}function H1(i){return i*3.6}function U1(i){return i*.6213711922}function $(i,e){return i===C.Imperial?W1(e):e}function _(i,e){return e=H1(e),i===C.Imperial?U1(e):e}M.register(R1,...E1);M.defaults.elements.line.borderWidth=1;M.defaults.elements.point.pointStyle="line";M.defaults.elements.point.radius=0;M.defaults.elements.point.borderWidth=0;M.defaults.elements.point.hoverBorderWidth=1;M.defaults.elements.point.rotation=90;M.defaults.elements.point.hoverRadius=1e3;M.defaults.elements.point.hoverBorderColor="#000000";M.defaults.elements.point.backgroundColor="rgba(0, 0, 0, 0)";M.defaults.elements.point.borderColor="rgba(0, 0, 0, 0)";L1.positioners.average=function(i,e){return e};const d=["#000000","#ff4500","#00b400","#8b4513","#2f4f4f","#556b2f","#483d8b","#0000ff","#000080","#9acd32","#8b008b","#66cdaa","#ffd700","#7cfc00","#00fa9a","#8a2be2","#dc143c","#00bfff","#f4a460","#d8bfd8","#ff00ff","#1e90ff","#db7093","#f0e68c","#ff1493","#ee82ee"],Y1=({track:i,unit:e,setActiveDatapointIndex:a})=>{const[t,n]=Z.exports.useState({elevation:!0,horizontalSpeed:!0,verticalSpeed:!0,totalSpeed:!1,course:!1,courseRate:!1,courseAccuracy:!1,glideRatio:!0,diveAngle:!1,diveRate:!1,horizontalAccuracy:!1,verticalAccuracy:!1,speedAccuracy:!1,numberOfSatellites:!1,acceleration:!1,accelerationForward:!1,accelerationRight:!1,accelerationDown:!1,accelerationMagnitude:!1,totalEnergy:!1,energyRate:!1,liftCoefficient:!1,dragCoefficient:!1}),r=Object.values(t).filter(s=>s).length>5,p=k.exports.useMediaQuery({query:"(max-width: 1224px)"}),f=k.exports.useMediaQuery({query:"(orientation: portrait)"}),T=r||p&&f,l=` (${e===C.Imperial?"ft":"m"})`,o=` (${e===C.Imperial?"mph":"km/h"})`,h=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:$(e,s.elevation)})),[e,i.datapoints]),g=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:_(e,s.horizontalSpeed)})),[e,i.datapoints]),m=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:_(e,s.verticalSpeed)})),[e,i.datapoints]),v=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:_(e,s.totalSpeed)})),[e,i.datapoints]),x=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.course})),[i.datapoints]);Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.courseRate})),[i.datapoints]);const A=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.courseAccuracy})),[i.datapoints]),S=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.glideRatio})),[i.datapoints]),R=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.diveAngle})),[i.datapoints]);Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:0})),[i.datapoints]);const b=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:$(e,s.horizontalAccuracy)})),[e,i.datapoints]),r1=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:$(e,s.verticalAccuracy)})),[e,i.datapoints]),l1=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:_(e,s.speedAccuracy)})),[e,i.datapoints]),c1=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.numberOfSatellites})),[i.datapoints]);Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.acceleration})),[i.datapoints]),Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.accForward})),[i.datapoints]),Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.accRight})),[i.datapoints]),Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.accDown})),[i.datapoints]),Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.accMagnitude})),[i.datapoints]);const d1=Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.totalEnergy})),[i.datapoints]);Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.energyRate})),[i.datapoints]),Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.liftCoefficient})),[i.datapoints]),Z.exports.useMemo(()=>i.datapoints.map((s,c)=>({x:c,y:s.dragCoefficient})),[i.datapoints]);const W=Z.exports.useMemo(()=>Math.max(...h.map(s=>s.y)),[h]),V=Z.exports.useMemo(()=>Math.floor(Math.min(Math.min(...g.map(s=>s.y)),Math.min(...m.map(s=>s.y)))),[g,m]),P=Z.exports.useMemo(()=>Math.ceil(Math.max(Math.max(...g.map(s=>s.y)),Math.max(...m.map(s=>s.y)))),[g,m]),H=Z.exports.useMemo(()=>Math.floor(Math.min(...S.map(s=>s.y))),[S]),U=Z.exports.useMemo(()=>Math.ceil(Math.max(...S.map(s=>s.y))),[S]),T1=Z.exports.useMemo(()=>({labels:i.datapoints.map((s,c)=>c),datasets:[{hidden:!t.elevation,label:"Elevation",data:h,borderColor:d[0],backgroundColor:d[0],yAxisID:"elevation"},{hidden:!t.horizontalSpeed,label:"Horizontal Speed",data:g,borderColor:d[1],backgroundColor:d[1],yAxisID:"horizontalSpeed"},{hidden:!t.verticalSpeed,label:"Vertical Speed",data:m,borderColor:d[2],backgroundColor:d[2],yAxisID:"verticalSpeed"},{hidden:!t.totalSpeed,label:"Total Speed",data:v,borderColor:d[3],backgroundColor:d[3],yAxisID:"totalSpeed"},{hidden:!t.course,label:"Course",data:x,borderColor:d[4],backgroundColor:d[4],yAxisID:"course"},{hidden:!t.courseAccuracy,label:"Course Accuracy",data:A,borderColor:d[6],backgroundColor:d[6],yAxisID:"courseAccuracy"},{hidden:!t.glideRatio,label:"Glide Ratio",data:S,borderColor:d[7],backgroundColor:d[7],yAxisID:"glideRatio"},{hidden:!t.diveAngle,label:"Dive Angle",data:R,borderColor:d[8],backgroundColor:d[8],yAxisID:"diveAngle"},{hidden:!t.horizontalAccuracy,label:"Horizontal Accuracy",data:b,borderColor:d[10],backgroundColor:d[10],yAxisID:"horizontalAccuracy"},{hidden:!t.verticalAccuracy,label:"Vertical Accuracy",data:r1,borderColor:d[11],backgroundColor:d[11],yAxisID:"verticalAccuracy"},{hidden:!t.speedAccuracy,label:"Speed Accuracy",data:l1,borderColor:d[12],backgroundColor:d[12],yAxisID:"speedAccuracy"},{hidden:!t.numberOfSatellites,label:"Number of Satellites",data:c1,borderColor:d[13],backgroundColor:d[13],stepped:!0,yAxisID:"numberOfSatellites"},{hidden:!t.totalEnergy,label:"Total Energy",data:d1,borderColor:d[19],backgroundColor:d[19],yAxisID:"totalEnergy"}]}),[h,g,m,S]),Z1=Z.exports.useMemo(()=>({responsive:!0,maintainAspectRatio:!1,parsing:!1,normalized:!0,interaction:{mode:"index",intersect:!1},animation:!1,plugins:{tooltip:{callbacks:{title:s=>{const c=s[0].dataIndex,w=i.datapoints[c],L=w.dateTime.getFullYear(),I=w.dateTime.getMonth()+1,G=w.dateTime.getDate(),O=w.dateTime.getHours(),h1=w.dateTime.getMinutes(),p1=w.dateTime.getSeconds(),f1=w.dateTime.getMilliseconds();return`${L}-${I}-${G} ${O}:${h1}:${p1}:${f1}`}}},legend:{labels:{boxHeight:5,boxWidth:5}},decimation:{enabled:!0,algorithm:"min-max"},zoom:{limits:{x:{minRange:10}},pan:{enabled:!0,mode:"x"},zoom:{wheel:{enabled:!0},pinch:{enabled:!0},mode:"x",drag:{enabled:!0,modifierKey:"shift"}}}},scales:{x:{ticks:{maxTicksLimit:10,callback:(s,c,w)=>typeof s!="number"?s:`${i.datapoints[s].time}s`}},elevation:{type:"linear",display:!T&&t.elevation,position:"right",title:{display:!0,text:"Elevation"+l,color:d[0]},min:0,max:W},horizontalSpeed:{type:"linear",display:!T&&t.horizontalSpeed,position:"left",title:{display:!0,text:"Horizontal Speed"+o,color:d[1]},min:V,max:P,grid:{drawOnChartArea:!1}},verticalSpeed:{type:"linear",display:!T&&t.verticalSpeed,position:"left",title:{display:!0,text:"Vertical Speed"+o,color:d[2]},min:V,max:P,grid:{drawOnChartArea:!1}},totalSpeed:{type:"linear",display:!T&&t.totalSpeed,position:"left",title:{display:!0,text:"Total Speed"+o,color:d[3]},bounds:"data",grid:{drawOnChartArea:!1}},course:{type:"linear",display:!T&&t.course,position:"left",title:{display:!0,text:"Course",color:d[4]},bounds:"data",grid:{drawOnChartArea:!1}},courseRate:{type:"linear",display:!T&&t.courseRate,position:"left",title:{display:!0,text:"Course Rate",color:d[5]},bounds:"data",grid:{drawOnChartArea:!1}},courseAccuracy:{type:"linear",display:!T&&t.courseAccuracy,position:"left",title:{display:!0,text:"Course Accuracy",color:d[6]},bounds:"data",grid:{drawOnChartArea:!1}},glideRatio:{type:"linear",display:!T&&t.glideRatio,position:"left",title:{display:!0,text:"Glide Ratio",color:d[7]},min:H,max:U,grid:{drawOnChartArea:!1}},diveAngle:{type:"linear",display:!T&&t.diveAngle,position:"left",title:{display:!0,text:"Dive Angle",color:d[8]},bounds:"data",grid:{drawOnChartArea:!1}},diveRate:{type:"linear",display:!T&&t.diveRate,position:"left",title:{display:!0,text:"Dive Rate",color:d[9]},bounds:"data",grid:{drawOnChartArea:!1}},horizontalAccuracy:{type:"linear",display:!T&&t.horizontalAccuracy,position:"left",title:{display:!0,text:"Horizontal Accuracy"+l,color:d[10]},bounds:"data",grid:{drawOnChartArea:!1}},verticalAccuracy:{type:"linear",display:!T&&t.verticalAccuracy,position:"left",title:{display:!0,text:"Vertical Accuracy"+l,color:d[11]},bounds:"data",grid:{drawOnChartArea:!1}},speedAccuracy:{type:"linear",display:!T&&t.speedAccuracy,position:"left",title:{display:!0,text:"Speed Accuracy"+o,color:d[12]},bounds:"data",grid:{drawOnChartArea:!1}},numberOfSatellites:{type:"linear",display:!T&&t.numberOfSatellites,position:"left",title:{display:!0,text:"Number of Satellites",color:d[13]},bounds:"data",grid:{drawOnChartArea:!1}},acceleration:{type:"linear",display:!T&&t.acceleration,position:"left",title:{display:!0,text:"Acceleration (m/s^2)",color:d[14]},bounds:"data",grid:{drawOnChartArea:!1}},accelerationForward:{type:"linear",display:!T&&t.accelerationForward,position:"left",title:{display:!0,text:"Acceleration Forward (m/s^2)",color:d[15]},bounds:"data",grid:{drawOnChartArea:!1}},accelerationRight:{type:"linear",display:!T&&t.accelerationRight,position:"left",title:{display:!0,text:"Acceleration Right (m/s^2)",color:d[16]},bounds:"data",grid:{drawOnChartArea:!1}},accelerationDown:{type:"linear",display:!T&&t.accelerationDown,position:"left",title:{display:!0,text:"Acceleration Down (m/s^2)",color:d[17]},bounds:"data",grid:{drawOnChartArea:!1}},accelerationMagnitude:{type:"linear",display:!T&&t.accelerationMagnitude,position:"left",title:{display:!0,text:"Acceleration Magnitude (m/s^2)",color:d[18]},bounds:"data",grid:{drawOnChartArea:!1}},totalEnergy:{type:"linear",display:!T&&t.totalEnergy,position:"left",title:{display:!0,text:"Total Energy (J/kg)",color:d[19]},bounds:"data",grid:{drawOnChartArea:!1}},energyRate:{type:"linear",display:!T&&t.energyRate,position:"left",title:{display:!0,text:"Energy Rate (J/kg/s)",color:d[20]},grid:{drawOnChartArea:!1}},liftCoefficient:{type:"linear",display:!T&&t.liftCoefficient,position:"left",title:{display:!0,text:"Lift Coefficient",color:d[21]},bounds:"data",grid:{drawOnChartArea:!1}},dragCoefficient:{type:"linear",display:!T&&t.dragCoefficient,position:"left",title:{display:!0,text:"Drag Coefficient",color:d[22]},bounds:"data",grid:{drawOnChartArea:!1}}}}),[T,W,V,P,H,U]),u1=Z.exports.useMemo(()=>[{id:"myEventCatcher",beforeEvent(s,c,w){const L=c.event;if(L.type==="mouseout"&&a(null),L.type==="mousemove"&&L.x){const G=s.canvas.getBoundingClientRect();var I=L.x-G.left;I>s.chartArea.right&&(I=s.chartArea.right);const O=s.scales.x.getValueForPixel(I);a(O!=null?O:null)}}}],[]);return y("div",{className:B1.Chart,children:y(z1,{height:300,data:T1,options:Z1,plugins:u1})})},X1="_App_1tt6o_1",K1="_ChartMap_1tt6o_5";var a1={App:X1,ChartMap:K1};const J1="_Load_jxcta_1",Q1="_Dialog_jxcta_11",k1="_UnitSelect_jxcta_18",e0="_DropArea_jxcta_25",t0="_DialogTitle_jxcta_38";var E={Load:J1,Dialog:Q1,UnitSelect:k1,DropArea:e0,DialogTitle:t0},n0=`time,lat,lon,hMSL,velN,velE,velD,hAcc,vAcc,sAcc,gpsFix,numSV
...
2010-09-11T21:25:09.00Z,53.6297011,-114.1799852,1868.334,-20.36,4.76,9.92,1.247,1.935,0.54,3,13`;const a0=B(({onLoad:i,setUnit:e})=>{const a=Z.exports.useRef(null);return z("div",{className:E.Load,children:[y(s1,{children:y("meta",{name:"theme-color",content:"#f0fbff"})}),z("div",{className:E.Dialog,children:[y("div",{className:E.DialogTitle,children:"Load FlySight CSV"}),z("div",{className:E.UnitSelect,children:[y("label",{htmlFor:"input-unit",children:"Units"}),z("select",{id:"input-unit",onChange:t=>e(t.target.value),children:[y("option",{value:C.Imperial,children:"Imperial (mph)"}),y("option",{value:C.Metric,children:"Metric (km/h)"})]})]}),z("div",{className:E.DropArea,onClick:t=>{var n;(n=a.current)==null||n.click()},children:[y("div",{children:"Press to select file"}),y("input",{style:{display:"none"},ref:a,type:"file",accept:".csv",className:E.FileInput,onChange:async t=>{var r;const n=(r=t.target.files)==null?void 0:r[0];if(n){const p=await n.text();i(p)}}})]}),y("a",{href:"#",className:E.Link,onClick:t=>{t.preventDefault(),i(n0)},children:"Load Sample"})]})]})}),i0=I1(B(()=>{const i=i1(),e=Z.exports.useRef(),[a,t]=Z.exports.useState(null),[n,r]=Z.exports.useState(null),[p,f]=Z.exports.useState(C.Imperial);return Z.exports.useEffect(()=>{if(e.current||!n)return;const T=new q1;return T.importFromText(n),e.current=T,i(),()=>{e.current=void 0}},[n]),y("div",{className:a1.App,children:e.current?z("div",{className:a1.ChartMap,children:[y(s1,{children:y("meta",{name:"theme-color",content:"#fff"})}),y(Y1,{track:e.current,unit:p,setActiveDatapointIndex:T=>t(T)}),y(j1,{track:e.current,activeDatapointIndex:a})]}):y(a0,{onLoad:T=>{e.current=void 0,r(T)},setUnit:f})})}),{showDialog:!0});O1({dsn:"https://975c9c3321074313ab41c1380cbf4c3c@o1200738.ingest.sentry.io/6324846",integrations:[new N1],tracesSampleRate:1});const o1=document.getElementById("root");if(!o1)throw new Error("Missing root element!");_1.render(y(F1.StrictMode,{children:y(V1,{children:y(i0,{})})}),o1);
//# sourceMappingURL=index.601decef.js.map
