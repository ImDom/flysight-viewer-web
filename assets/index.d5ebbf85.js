var J=Object.defineProperty;var n1=(o,n,e)=>n in o?J(o,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[n]=e;var T=(o,n,e)=>(n1(o,typeof n!="symbol"?n+"":n,e),e);import{g as z,P as t1,w as P,u as X,r as u,L as V,S as G,O as q,G as e1,a as O,b as s1,c as i1,d as j,e as a1,j as m,f as C,h as r1,i as o1,k as T1,l as Z1,m as l1,C as S,p as c1,n as h1,o as d1,q as u1,s as m1,t as g1,v as f1,x as p1,y as v1,z as k,A as y1,B as L,W as Y,D as x1,E as S1,F as M1,R as A1,H as w1,I as D1}from"./vendor.b29500e0.js";const E1=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function e(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerpolicy&&(a.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?a.credentials="include":t.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(t){if(t.ep)return;t.ep=!0;const a=e(t);fetch(t.href,a)}};E1();const I=9.80665,b1=101325,F=.0065,B=288.15,W=.0289644,U=8.31447;class A{constructor(n){T(this,"dateTime");T(this,"hasGeodetic");T(this,"lat");T(this,"lon");T(this,"hMSL");T(this,"velN");T(this,"velE");T(this,"velD");T(this,"hAcc");T(this,"vAcc");T(this,"sAcc");T(this,"heading");T(this,"cAcc");T(this,"numSV");T(this,"t");T(this,"x");T(this,"y");T(this,"z");T(this,"dist2D");T(this,"dist3D");T(this,"curv");T(this,"accel");T(this,"ax");T(this,"ay");T(this,"az");T(this,"amag");T(this,"lift");T(this,"drag");T(this,"vx");T(this,"vy");T(this,"theta");T(this,"omega");this.raw=n,this.raw&&(this.hasGeodetic=!0,this.dateTime=new Date(this.raw.time),this.lat=parseFloat(this.raw.lat),this.lon=parseFloat(this.raw.lon),this.hMSL=parseFloat(this.raw.hMSL),this.velN=parseFloat(this.raw.velN),this.velE=parseFloat(this.raw.velE),this.velD=parseFloat(this.raw.velD),this.hAcc=parseFloat(this.raw.hAcc),this.vAcc=parseFloat(this.raw.vAcc),this.sAcc=parseFloat(this.raw.sAcc),this.numSV=parseInt(this.raw.numSV,10))}get elevation(){return this.z}get northSpeed(){return this.vy}get eastSpeed(){return this.vx}get northSpeedRaw(){return this.velN}get eastSpeedRaw(){return this.velE}get verticalSpeed(){return this.velD}get horizontalSpeed(){return Math.sqrt(this.vx*this.vx+this.vy*this.vy)}get totalSpeed(){return Math.sqrt(this.vx*this.vx+this.vy*this.vy+this.velD*this.velD)}get diveAngle(){return Math.atan2(this.velD,Math.sqrt(this.vx*this.vx+this.vy*this.vy))/Math.PI*180}get curvature(){return this.curv}get glideRatio(){return this.velD!=0?Math.sqrt(this.vx*this.vx+this.vy*this.vy)/this.velD:0}get horizontalAccuracy(){return this.hAcc}get verticalAccuracy(){return this.vAcc}get speedAccuracy(){return this.sAcc}get numberOfSatellites(){return this.numSV}get time(){return this.t}get distance2D(){return this.dist2D}get distance3D(){return this.dist3D}get acceleration(){return this.accel}get accForward(){return this.ax}get accRight(){return this.ay}get accDown(){return this.az}get accMagnitude(){return this.amag}get totalEnergy(){const n=this.totalSpeed;return n*n/2+I*this.elevation}get energyRate(){return this.totalSpeed*this.acceleration-I*this.verticalSpeed}get liftCoefficient(){return this.lift}get dragCoefficient(){return this.drag}get course(){return this.theta}get courseRate(){return this.omega}get courseAccuracy(){return this.cAcc}static interpolate(n,e,s){const t=new A,a=n.dateTime.getTime(),l=e.dateTime.getTime();return t.dateTime=new Date,t.dateTime.setTime(a+s*(l-a)),t.hasGeodetic=n.hasGeodetic&&e.hasGeodetic,t.lat=n.lat+s*(e.lat-n.lat),t.lon=n.lon+s*(e.lon-n.lon),t.hMSL=n.hMSL+s*(e.hMSL-n.hMSL),t.velN=n.velN+s*(e.velN-n.velN),t.velE=n.velE+s*(e.velE-n.velE),t.velD=n.velD+s*(e.velD-n.velD),t.hAcc=n.hAcc+s*(e.hAcc-n.hAcc),t.vAcc=n.vAcc+s*(e.vAcc-n.vAcc),t.sAcc=n.sAcc+s*(e.sAcc-n.sAcc),s<.5?t.numSV=n.numSV:t.numSV=e.numSV,t.t=n.t+s*(e.t-n.t),t.x=n.x+s*(e.x-n.x),t.y=n.y+s*(e.y-n.y),t.z=n.z+s*(e.z-n.z),t.dist2D=n.dist2D+s*(e.dist2D-n.dist2D),t.dist3D=n.dist3D+s*(e.dist3D-n.dist3D),t.curv=n.curv+s*(e.curv-n.curv),t.accel=n.accel+s*(e.accel-n.accel),t.ax=n.ax+s*(e.ax-n.ax),t.ay=n.ay+s*(e.ay-n.ay),t.az=n.az+s*(e.az-n.az),t.amag=n.amag+s*(e.amag-n.amag),t.lift=n.lift+s*(e.lift-n.lift),t.drag=n.drag+s*(e.drag-n.drag),t.heading=n.heading+s*(e.heading-n.heading),t.cAcc=n.cAcc+s*(e.cAcc-n.cAcc),t.vx=n.vx+s*(e.vx-n.vx),t.vy=n.vy+s*(e.vy-n.vy),t.theta=n.theta+s*(e.theta-n.theta),t.omega=n.omega+s*(e.omega-n.omega),t}static getDistance(n,e,s){if(!s&&n.hasGeodetic&&e.hasGeodetic)return z([n.lat,n.lon],[e.lat,e.lon]);{const t=e.x-n.x,a=e.y-n.y;return Math.sqrt(t*t+a*a)}}static getBearing(n,e,s){if(!s&&n.hasGeodetic&&e.hasGeodetic){const t=z([n.lat,0],[e.lat,0]);return z([0,n.lon],[0,e.lon]),t/180*Math.PI}else{const t=e.x-n.x,a=e.y-n.y;return Math.atan2(t,a)}}}class L1{constructor(){T(this,"options",{groundReference:0,fixedReference:0,windAdjustment:!1,windE:0,windN:0,mass:90,planformArea:2});T(this,"wind");T(this,"ground");T(this,"course");T(this,"datapoints",[])}importFromText(n){t1.parse(n,{header:!0,skipEmptyLines:!0}).data.forEach(s=>{!s.time||this.datapoints.push(new A(s))}),this.initTime(),this.initAltitude(),this.initAcceleration(),this.updateVelocity(!0),console.log("Track:",this)}initTime(){const n=this.datapoints[0].dateTime.getTime();this.datapoints.forEach((e,s)=>{const t=e.dateTime.getTime();e.t=(t-n)/1e3})}initExit(){}initAltitude(){let n;this.ground?n=this.ground:this.options.groundReference===0?n=this.datapoints[this.datapoints.length-1].hMSL:n=this.options.fixedReference,this.ground=n,this.datapoints.forEach((e,s)=>{e.z=e.hMSL-n})}initAcceleration(){this.datapoints.forEach((n,e)=>{const s=this.getSlope(e,n.northSpeedRaw),t=this.getSlope(e,n.eastSpeedRaw),a=this.getSlope(e,n.verticalSpeed),l=Math.sqrt(n.velN*n.velN+n.velE*n.velE);n.ax=(s*n.velN+t*n.velE)/l,n.ay=(t*n.velN-s*n.velE)/l,n.az=a,n.amag=Math.sqrt(s*s+t*t+a*a)})}initAerodynamics(){this.datapoints.forEach((n,e)=>{let s=this.getSlope(e,n.northSpeed),t=this.getSlope(e,n.eastSpeed),a=this.getSlope(e,n.verticalSpeed);a-=I;const l=n.totalSpeed,c=(s*n.vy+t*n.vx+a*n.velD)/l,d=c*n.vy/l,r=c*n.vx/l,i=c*n.velD/l,Z=Math.sqrt(d*d+r*r+i*i),g=s-d,p=t-r,f=a-i,v=Math.sqrt(g*g+p*p+f*f),y=b1*Math.pow(1-F*n.hMSL/B,I*W/U/F),D=B-F*n.hMSL,M=y/(U/W)/D*l*l/2;n.lift=this.options.mass*v/M/this.options.planformArea,n.drag=this.options.mass*Z/M/this.options.planformArea})}updateVelocity(n=!1){if(this.datapoints.length===0)return;const e=this.getWind();if(n&&(this.wind=e),this.options.windAdjustment){for(let r=0;r<this.datapoints.length;++r){const i=this.interpolateDataT(0),Z=this.datapoints[r],g=A.getDistance(i,Z,this.options.windAdjustment),p=A.getBearing(i,Z,this.options.windAdjustment);Z.x=g*Math.sin(p)-e.east*Z.t,Z.y=g*Math.cos(p)-e.north*Z.t}for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.vx=i.velE-e.east,i.vy=i.velN-e.north}}else{for(let r=0;r<this.datapoints.length;++r){const i=this.interpolateDataT(0),Z=this.datapoints[r],g=A.getDistance(i,Z,this.options.windAdjustment),p=A.getBearing(i,Z,this.options.windAdjustment);Z.x=g*Math.sin(p),Z.y=g*Math.cos(p)}for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.vx=i.velE,i.vy=i.velN}}let s=0,t=0;for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];if(r>0){const Z=this.datapoints[r-1],g=i.x-Z.x,p=i.y-Z.y,f=Math.sqrt(g*g+p*p),v=i.hMSL-Z.hMSL;s+=f,t+=Math.sqrt(f*f+v*v)}i.dist2D=s,i.dist3D=t}const a=this.interpolateDataT(0);for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.x-=a.x,i.y-=a.y,i.dist2D-=a.dist2D,i.dist3D-=a.dist3D}let l;this.course?l=this.course:l=0,n&&(this.course=l);let c=0,d=!0;for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.heading=Math.atan2(i.vx,i.vy)/Math.PI*180;const Z=i.totalSpeed;if(Z!=0?i.cAcc=i.sAcc/Z:i.cAcc=0,!d){for(;i.heading<c-180;)i.heading+=360;for(;i.heading>=c+180;)i.heading-=360}i.theta=i.heading-l,d=!1,c=i.heading}for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.curv=this.getSlope(r,i.diveAngle),i.accel=this.getSlope(r,i.totalSpeed),i.omega=this.getSlope(r,i.course)}this.initAerodynamics()}getSlope(n,e){const s=Math.max(0,n-4),t=Math.min(this.datapoints.length-1,n+4);let a=0,l=0,c=0,d=0;for(let i=s;i<=t;++i){const Z=this.datapoints[i],g=e;a+=Z.t,l+=g,c+=Z.t*Z.t,d+=Z.t*g}const r=t-s+1;return(d-a*l/r)/(c-a*a/r)}getWind(){return this.wind?this.wind:{east:this.options.windE,north:this.options.windN}}getWindSpeedDirection(){const n=this.getWind(),e=Math.sqrt(n.east*n.east+n.north*n.north);let s=Math.atan2(-n.east,-n.north)/Math.PI;return s<0&&(s+=360),{speed:e,direction:s}}interpolateDataT(n){const e=this.findIndexBelowT(n),s=this.findIndexAboveT(n);if(e<0)return this.datapoints[0];if(s>=this.datapoints.length)return this.datapoints[this.datapoints.length-1];{const t=this.datapoints[e],a=this.datapoints[s];return A.interpolate(t,a,(n-t.t)/(a.t-t.t))}}findIndexBelowT(n){let e=-1,s=this.datapoints.length;for(;e+1!==s;){const t=Math.floor((e+s)/2);this.datapoints[t].t<n?e=t:s=t}return e}findIndexAboveT(n){let e=-1,s=this.datapoints.length;for(;e+1!==s;){const t=Math.ceil((e+s)/2);this.datapoints[t].t>n?s=t:e=t}return s}}const R1=P(({track:o,activeDatapointIndex:n})=>{const e=X(),s=u.exports.useRef(null),t=u.exports.useRef(),a=u.exports.useRef();function l(c){var d,r;(r=(d=a.current)==null?void 0:d.getSource())==null||r.forEachFeature(i=>{const Z=c?C([c.lon,c.lat]):[0,0];i.getGeometry().setCoordinates(Z)})}return u.exports.useEffect(()=>(!a.current&&t.current&&(console.log("Initializing marker"),a.current=new V({source:new G({features:[new q({geometry:new e1([0,0]),name:"Point"})]})}),a.current.setStyle(new O({image:new s1({fill:new i1({color:"#000000"}),stroke:new j({color:"#ff0000",width:2}),radius:3})})),t.current.addLayer(a.current)),()=>{var c;(c=a.current)==null||c.dispose(),a.current=void 0}),[t.current]),u.exports.useEffect(()=>{if(a.current&&t.current&&n){const c=o.datapoints[n];l(c)}},[n]),a1(()=>{var g,p;if(t.current||!s.current)return;console.info("Initializing map");const c=o.datapoints[0];t.current=new r1({target:s.current,layers:[new o1({source:new T1({url:"https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",maxZoom:19,attributions:"ArcGIS"})})],view:new Z1({center:C([c.lon,c.lat]),zoom:14})});var d=[new O({stroke:new j({color:"#d12710",width:2})})],r=new V({source:new G({features:o.datapoints.map((f,v)=>{let y=o.datapoints[v+1];y||(y=f);var D=C([f.lon,f.lat]),E=C([y.lon,y.lat]);const M=new q({geometry:new l1([D,E]),name:"Line"});return M.setId(v),M})})});r.setStyle(d),t.current.addLayer(r);const i=(g=r.getSource())==null?void 0:g.getExtent();i&&t.current.getView().fit(i,{padding:[50,50,50,50]});const Z=f=>{var v;f.dragging||(v=t.current)==null||v.forEachFeatureAtPixel(f.pixel,(y,D)=>{if(!D)return!0;const E=y.getId();if(typeof E=="number"){const M=o.datapoints[E];return l(M),!!M}},{hitTolerance:10,layerFilter:y=>y===r})};return t.current.on("pointermove",Z),(p=t.current)==null||p.on("singleclick",Z),e(),()=>{var f;(f=t.current)==null||f.dispose(),t.current=void 0}}),m("div",{style:{width:"100%",height:"100%"},ref:s})});var w=(o=>(o[o.Metric=0]="Metric",o[o.Imperial=1]="Imperial",o))(w||{});const C1="_Chart_1q3ui_1";var I1={Chart:C1};function N1(o){return o*3.28084}function _1(o){return o*3.6}function z1(o){return o*.6213711922}function F1(o,n){return o===w.Imperial?N1(n):n}function $(o,n){return n=_1(n),o===w.Imperial?z1(n):n}S.register(c1,h1,d1,u1,m1,g1,f1,p1,v1);S.defaults.elements.line.borderWidth=1;S.defaults.elements.point.pointStyle="line";S.defaults.elements.point.radius=0;S.defaults.elements.point.borderWidth=0;S.defaults.elements.point.hoverBorderWidth=1;S.defaults.elements.point.rotation=90;S.defaults.elements.point.hoverRadius=1e3;S.defaults.elements.point.hoverBorderColor="#000000";S.defaults.elements.point.backgroundColor="rgba(0, 0, 0, 0)";S.defaults.elements.point.borderColor="rgba(0, 0, 0, 0)";const P1=({track:o,unit:n,setActiveDatapointIndex:e})=>{const s=k.exports.useMediaQuery({query:"(max-width: 1224px)"}),t=k.exports.useMediaQuery({query:"(orientation: portrait)"}),a=s&&t,l=` (${n===w.Imperial?"ft":"m"})`,c=` (${n===w.Imperial?"mph":"km/h"})`,d=u.exports.useMemo(()=>o.datapoints.map((h,x)=>({x,y:F1(n,h.elevation)})),[n,o.datapoints]),r=u.exports.useMemo(()=>o.datapoints.map((h,x)=>({x,y:$(n,h.horizontalSpeed)})),[n,o.datapoints]),i=u.exports.useMemo(()=>o.datapoints.map((h,x)=>({x,y:$(n,h.verticalSpeed)})),[n,o.datapoints]),Z=u.exports.useMemo(()=>o.datapoints.map((h,x)=>({x,y:h.glideRatio})),[o.datapoints]),g=u.exports.useMemo(()=>Math.max(...d.map(h=>h.y)),[d]),p=u.exports.useMemo(()=>Math.floor(Math.min(Math.min(...r.map(h=>h.y)),Math.min(...i.map(h=>h.y)))),[r,i]),f=u.exports.useMemo(()=>Math.ceil(Math.max(Math.max(...r.map(h=>h.y)),Math.max(...i.map(h=>h.y)))),[r,i]),v=u.exports.useMemo(()=>Math.floor(Math.min(...Z.map(h=>h.y))),[Z]),y=u.exports.useMemo(()=>Math.ceil(Math.max(...Z.map(h=>h.y))),[Z]),D=u.exports.useMemo(()=>({labels:o.datapoints.map((h,x)=>x),datasets:[{label:"Elevation",data:d,borderColor:"#000000",backgroundColor:"#000000",yAxisID:"y"},{label:"Horizontal Speed",data:r,borderColor:"#ff0000",backgroundColor:"#ff0000",yAxisID:"y1"},{label:"Vertical Speed",data:i,borderColor:"#00ff00",backgroundColor:"#00ff00",yAxisID:"y2"},{label:"Glide Ratio",data:Z,borderColor:"#0000ff",backgroundColor:"#0000ff",yAxisID:"y3"}]}),[d,r,i,Z]),E=u.exports.useMemo(()=>({responsive:!0,maintainAspectRatio:!1,parsing:!1,normalized:!0,interaction:{mode:"index",intersect:!1},animation:!1,plugins:{legend:{labels:{boxHeight:5,boxWidth:5}},decimation:{enabled:!0,algorithm:"min-max"},zoom:{limits:{x:{minRange:10}},pan:{enabled:!0,mode:"x"},zoom:{wheel:{enabled:!0},pinch:{enabled:!0},mode:"x",drag:{enabled:!0,modifierKey:"shift"}}}},scales:{y:{type:"linear",display:!a,position:"right",title:{display:!0,text:"Elevation"+l,color:"#000000"},min:0,max:g},y1:{type:"linear",display:!a,position:"left",title:{display:!0,text:"Horizontal Speed"+c,color:"#ff0000"},min:p,max:f,grid:{drawOnChartArea:!1}},y2:{type:"linear",display:!a,position:"left",title:{display:!0,text:"Vertical Speed"+c,color:"#00ff00"},min:p,max:f,grid:{drawOnChartArea:!1}},y3:{type:"linear",display:!a,position:"left",title:{display:!0,text:"Glide Ratio",color:"#0000ff"},min:v,max:y,grid:{drawOnChartArea:!1}}}}),[a,g,p,f,v,y]),M=u.exports.useMemo(()=>[{id:"myEventCatcher",beforeEvent(h,x,H1){const R=x.event;if(R.type==="mouseout"&&e(null),R.type==="mousemove"&&R.x){const Q=h.canvas.getBoundingClientRect();var N=R.x-Q.left;N>h.chartArea.right&&(N=h.chartArea.right);const _=h.scales.x.getValueForPixel(N);e(_!=null?_:null)}}}],[]);return m("div",{className:I1.Chart,children:m(y1,{height:300,data:D,options:E,plugins:M})})},V1="_App_1tt6o_1",G1="_ChartMap_1tt6o_5";var H={App:V1,ChartMap:G1};const q1="_Load_jxcta_1",O1="_Dialog_jxcta_11",j1="_UnitSelect_jxcta_18",k1="_DropArea_jxcta_25",B1="_DialogTitle_jxcta_38";var b={Load:q1,Dialog:O1,UnitSelect:j1,DropArea:k1,DialogTitle:B1},W1=`time,lat,lon,hMSL,velN,velE,velD,hAcc,vAcc,sAcc,gpsFix,numSV
...
2010-09-11T21:25:09.00Z,53.6297011,-114.1799852,1868.334,-20.36,4.76,9.92,1.247,1.935,0.54,3,13`;const U1=P(({onLoad:o,setUnit:n})=>{const e=u.exports.useRef(null);return L("div",{className:b.Load,children:[m(Y,{children:m("meta",{name:"theme-color",content:"#f0fbff"})}),L("div",{className:b.Dialog,children:[m("div",{className:b.DialogTitle,children:"Load FlySight CSV"}),L("div",{className:b.UnitSelect,children:[m("label",{htmlFor:"input-unit",children:"Units"}),L("select",{id:"input-unit",onChange:s=>n(s.target.value),children:[m("option",{value:w.Imperial,children:"Imperial (mph)"}),m("option",{value:w.Metric,children:"Metric (km/h)"})]})]}),L("div",{className:b.DropArea,onClick:s=>{var t;(t=e.current)==null||t.click()},children:[m("div",{children:"Press to select file"}),m("input",{style:{display:"none"},ref:e,type:"file",accept:".csv",className:b.FileInput,onChange:async s=>{var a;const t=(a=s.target.files)==null?void 0:a[0];if(t){const l=await t.text();o(l)}}})]}),m("a",{href:"#",className:b.Link,onClick:s=>{s.preventDefault(),o(W1)},children:"Load Sample"})]})]})}),$1=x1(P(()=>{const o=X(),n=u.exports.useRef(),[e,s]=u.exports.useState(null),[t,a]=u.exports.useState(null),[l,c]=u.exports.useState(w.Imperial);return u.exports.useEffect(()=>{if(n.current||!t)return;const d=new L1;return d.importFromText(t),n.current=d,o(),()=>{n.current=void 0}},[t]),m("div",{className:H.App,children:n.current?L("div",{className:H.ChartMap,children:[m(Y,{children:m("meta",{name:"theme-color",content:"#fff"})}),m(P1,{track:n.current,unit:l,setActiveDatapointIndex:d=>s(d)}),m(R1,{track:n.current,activeDatapointIndex:e})]}):m(U1,{onLoad:d=>{n.current=void 0,a(d)},setUnit:c})})}),{showDialog:!0});S1({dsn:"https://975c9c3321074313ab41c1380cbf4c3c@o1200738.ingest.sentry.io/6324846",integrations:[new M1],tracesSampleRate:1});const K=document.getElementById("root");if(!K)throw new Error("Missing root element!");A1.render(m(w1.StrictMode,{children:m(D1,{children:m($1,{})})}),K);
//# sourceMappingURL=index.d5ebbf85.js.map
