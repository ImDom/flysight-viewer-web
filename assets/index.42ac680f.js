var Y=Object.defineProperty;var K=(o,n,e)=>n in o?Y(o,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[n]=e;var T=(o,n,e)=>(K(o,typeof n!="symbol"?n+"":n,e),e);import{g as N,P as J,w as z,u as U,r as u,L as F,S as P,O as V,G as Q,a as G,b as n1,c as t1,d as q,e as e1,j as m,f as b,h as s1,i as i1,k as a1,l as r1,m as o1,C as S,p as T1,n as Z1,o as l1,q as c1,s as h1,t as d1,v as u1,x as m1,y as g1,z as E,W as $,A as f1,B as p1,D as v1,R as y1,E as x1,F as S1}from"./vendor.8bccba7c.js";const M1=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const Z of a.addedNodes)Z.tagName==="LINK"&&Z.rel==="modulepreload"&&s(Z)}).observe(document,{childList:!0,subtree:!0});function e(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerpolicy&&(a.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?a.credentials="include":t.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(t){if(t.ep)return;t.ep=!0;const a=e(t);fetch(t.href,a)}};M1();const R=9.80665,A1=101325,_=.0065,j=288.15,k=.0289644,O=8.31447;class A{constructor(n){T(this,"dateTime");T(this,"hasGeodetic");T(this,"lat");T(this,"lon");T(this,"hMSL");T(this,"velN");T(this,"velE");T(this,"velD");T(this,"hAcc");T(this,"vAcc");T(this,"sAcc");T(this,"heading");T(this,"cAcc");T(this,"numSV");T(this,"t");T(this,"x");T(this,"y");T(this,"z");T(this,"dist2D");T(this,"dist3D");T(this,"curv");T(this,"accel");T(this,"ax");T(this,"ay");T(this,"az");T(this,"amag");T(this,"lift");T(this,"drag");T(this,"vx");T(this,"vy");T(this,"theta");T(this,"omega");this.raw=n,this.raw&&(this.hasGeodetic=!0,this.dateTime=new Date(this.raw.time),this.lat=parseFloat(this.raw.lat),this.lon=parseFloat(this.raw.lon),this.hMSL=parseFloat(this.raw.hMSL),this.velN=parseFloat(this.raw.velN),this.velE=parseFloat(this.raw.velE),this.velD=parseFloat(this.raw.velD),this.hAcc=parseFloat(this.raw.hAcc),this.vAcc=parseFloat(this.raw.vAcc),this.sAcc=parseFloat(this.raw.sAcc),this.numSV=parseInt(this.raw.numSV,10))}get elevation(){return this.z}get northSpeed(){return this.vy}get eastSpeed(){return this.vx}get northSpeedRaw(){return this.velN}get eastSpeedRaw(){return this.velE}get verticalSpeed(){return this.velD}get horizontalSpeed(){return Math.sqrt(this.vx*this.vx+this.vy*this.vy)}get totalSpeed(){return Math.sqrt(this.vx*this.vx+this.vy*this.vy+this.velD*this.velD)}get diveAngle(){return Math.atan2(this.velD,Math.sqrt(this.vx*this.vx+this.vy*this.vy))/Math.PI*180}get curvature(){return this.curv}get glideRatio(){return this.velD!=0?Math.sqrt(this.vx*this.vx+this.vy*this.vy)/this.velD:0}get horizontalAccuracy(){return this.hAcc}get verticalAccuracy(){return this.vAcc}get speedAccuracy(){return this.sAcc}get numberOfSatellites(){return this.numSV}get time(){return this.t}get distance2D(){return this.dist2D}get distance3D(){return this.dist3D}get acceleration(){return this.accel}get accForward(){return this.ax}get accRight(){return this.ay}get accDown(){return this.az}get accMagnitude(){return this.amag}get totalEnergy(){const n=this.totalSpeed;return n*n/2+R*this.elevation}get energyRate(){return this.totalSpeed*this.acceleration-R*this.verticalSpeed}get liftCoefficient(){return this.lift}get dragCoefficient(){return this.drag}get course(){return this.theta}get courseRate(){return this.omega}get courseAccuracy(){return this.cAcc}static interpolate(n,e,s){const t=new A,a=n.dateTime.getTime(),Z=e.dateTime.getTime();return t.dateTime=new Date,t.dateTime.setTime(a+s*(Z-a)),t.hasGeodetic=n.hasGeodetic&&e.hasGeodetic,t.lat=n.lat+s*(e.lat-n.lat),t.lon=n.lon+s*(e.lon-n.lon),t.hMSL=n.hMSL+s*(e.hMSL-n.hMSL),t.velN=n.velN+s*(e.velN-n.velN),t.velE=n.velE+s*(e.velE-n.velE),t.velD=n.velD+s*(e.velD-n.velD),t.hAcc=n.hAcc+s*(e.hAcc-n.hAcc),t.vAcc=n.vAcc+s*(e.vAcc-n.vAcc),t.sAcc=n.sAcc+s*(e.sAcc-n.sAcc),s<.5?t.numSV=n.numSV:t.numSV=e.numSV,t.t=n.t+s*(e.t-n.t),t.x=n.x+s*(e.x-n.x),t.y=n.y+s*(e.y-n.y),t.z=n.z+s*(e.z-n.z),t.dist2D=n.dist2D+s*(e.dist2D-n.dist2D),t.dist3D=n.dist3D+s*(e.dist3D-n.dist3D),t.curv=n.curv+s*(e.curv-n.curv),t.accel=n.accel+s*(e.accel-n.accel),t.ax=n.ax+s*(e.ax-n.ax),t.ay=n.ay+s*(e.ay-n.ay),t.az=n.az+s*(e.az-n.az),t.amag=n.amag+s*(e.amag-n.amag),t.lift=n.lift+s*(e.lift-n.lift),t.drag=n.drag+s*(e.drag-n.drag),t.heading=n.heading+s*(e.heading-n.heading),t.cAcc=n.cAcc+s*(e.cAcc-n.cAcc),t.vx=n.vx+s*(e.vx-n.vx),t.vy=n.vy+s*(e.vy-n.vy),t.theta=n.theta+s*(e.theta-n.theta),t.omega=n.omega+s*(e.omega-n.omega),t}static getDistance(n,e,s){if(!s&&n.hasGeodetic&&e.hasGeodetic)return N([n.lat,n.lon],[e.lat,e.lon]);{const t=e.x-n.x,a=e.y-n.y;return Math.sqrt(t*t+a*a)}}static getBearing(n,e,s){if(!s&&n.hasGeodetic&&e.hasGeodetic){const t=N([n.lat,0],[e.lat,0]);return N([0,n.lon],[0,e.lon]),t/180*Math.PI}else{const t=e.x-n.x,a=e.y-n.y;return Math.atan2(t,a)}}}class D1{constructor(){T(this,"options",{groundReference:0,fixedReference:0,windAdjustment:!1,windE:0,windN:0,mass:90,planformArea:2});T(this,"wind");T(this,"ground");T(this,"course");T(this,"datapoints",[])}importFromText(n){J.parse(n,{header:!0,skipEmptyLines:!0}).data.forEach(s=>{!s.time||this.datapoints.push(new A(s))}),this.initTime(),this.initAltitude(),this.initAcceleration(),this.updateVelocity(!0),console.log("Track:",this)}initTime(){const n=this.datapoints[0].dateTime.getTime();this.datapoints.forEach((e,s)=>{const t=e.dateTime.getTime();e.t=(t-n)/1e3})}initExit(){}initAltitude(){let n;this.ground?n=this.ground:this.options.groundReference===0?n=this.datapoints[this.datapoints.length-1].hMSL:n=this.options.fixedReference,this.ground=n,this.datapoints.forEach((e,s)=>{e.z=e.hMSL-n})}initAcceleration(){this.datapoints.forEach((n,e)=>{const s=this.getSlope(e,n.northSpeedRaw),t=this.getSlope(e,n.eastSpeedRaw),a=this.getSlope(e,n.verticalSpeed),Z=Math.sqrt(n.velN*n.velN+n.velE*n.velE);n.ax=(s*n.velN+t*n.velE)/Z,n.ay=(t*n.velN-s*n.velE)/Z,n.az=a,n.amag=Math.sqrt(s*s+t*t+a*a)})}initAerodynamics(){this.datapoints.forEach((n,e)=>{let s=this.getSlope(e,n.northSpeed),t=this.getSlope(e,n.eastSpeed),a=this.getSlope(e,n.verticalSpeed);a-=R;const Z=n.totalSpeed,h=(s*n.vy+t*n.vx+a*n.velD)/Z,d=h*n.vy/Z,r=h*n.vx/Z,i=h*n.velD/Z,l=Math.sqrt(d*d+r*r+i*i),g=s-d,p=t-r,f=a-i,y=Math.sqrt(g*g+p*p+f*f),x=A1*Math.pow(1-_*n.hMSL/j,R*k/O/_),c=j-_*n.hMSL,M=x/(O/k)/c*Z*Z/2;n.lift=this.options.mass*y/M/this.options.planformArea,n.drag=this.options.mass*l/M/this.options.planformArea})}updateVelocity(n=!1){if(this.datapoints.length===0)return;const e=this.getWind();if(n&&(this.wind=e),this.options.windAdjustment){for(let r=0;r<this.datapoints.length;++r){const i=this.interpolateDataT(0),l=this.datapoints[r],g=A.getDistance(i,l,this.options.windAdjustment),p=A.getBearing(i,l,this.options.windAdjustment);l.x=g*Math.sin(p)-e.east*l.t,l.y=g*Math.cos(p)-e.north*l.t}for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.vx=i.velE-e.east,i.vy=i.velN-e.north}}else{for(let r=0;r<this.datapoints.length;++r){const i=this.interpolateDataT(0),l=this.datapoints[r],g=A.getDistance(i,l,this.options.windAdjustment),p=A.getBearing(i,l,this.options.windAdjustment);l.x=g*Math.sin(p),l.y=g*Math.cos(p)}for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.vx=i.velE,i.vy=i.velN}}let s=0,t=0;for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];if(r>0){const l=this.datapoints[r-1],g=i.x-l.x,p=i.y-l.y,f=Math.sqrt(g*g+p*p),y=i.hMSL-l.hMSL;s+=f,t+=Math.sqrt(f*f+y*y)}i.dist2D=s,i.dist3D=t}const a=this.interpolateDataT(0);for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.x-=a.x,i.y-=a.y,i.dist2D-=a.dist2D,i.dist3D-=a.dist3D}let Z;this.course?Z=this.course:Z=0,n&&(this.course=Z);let h=0,d=!0;for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.heading=Math.atan2(i.vx,i.vy)/Math.PI*180;const l=i.totalSpeed;if(l!=0?i.cAcc=i.sAcc/l:i.cAcc=0,!d){for(;i.heading<h-180;)i.heading+=360;for(;i.heading>=h+180;)i.heading-=360}i.theta=i.heading-Z,d=!1,h=i.heading}for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.curv=this.getSlope(r,i.diveAngle),i.accel=this.getSlope(r,i.totalSpeed),i.omega=this.getSlope(r,i.course)}this.initAerodynamics()}getSlope(n,e){const s=Math.max(0,n-4),t=Math.min(this.datapoints.length-1,n+4);let a=0,Z=0,h=0,d=0;for(let i=s;i<=t;++i){const l=this.datapoints[i],g=e;a+=l.t,Z+=g,h+=l.t*l.t,d+=l.t*g}const r=t-s+1;return(d-a*Z/r)/(h-a*a/r)}getWind(){return this.wind?this.wind:{east:this.options.windE,north:this.options.windN}}getWindSpeedDirection(){const n=this.getWind(),e=Math.sqrt(n.east*n.east+n.north*n.north);let s=Math.atan2(-n.east,-n.north)/Math.PI;return s<0&&(s+=360),{speed:e,direction:s}}interpolateDataT(n){const e=this.findIndexBelowT(n),s=this.findIndexAboveT(n);if(e<0)return this.datapoints[0];if(s>=this.datapoints.length)return this.datapoints[this.datapoints.length-1];{const t=this.datapoints[e],a=this.datapoints[s];return A.interpolate(t,a,(n-t.t)/(a.t-t.t))}}findIndexBelowT(n){let e=-1,s=this.datapoints.length;for(;e+1!==s;){const t=Math.floor((e+s)/2);this.datapoints[t].t<n?e=t:s=t}return e}findIndexAboveT(n){let e=-1,s=this.datapoints.length;for(;e+1!==s;){const t=Math.ceil((e+s)/2);this.datapoints[t].t>n?s=t:e=t}return s}}const w1=z(({track:o,activeDatapointIndex:n})=>{const e=U(),s=u.exports.useRef(null),t=u.exports.useRef(),a=u.exports.useRef();function Z(h){var d,r;(r=(d=a.current)==null?void 0:d.getSource())==null||r.forEachFeature(i=>{const l=h?b([h.lon,h.lat]):[0,0];i.getGeometry().setCoordinates(l)})}return u.exports.useEffect(()=>(!a.current&&t.current&&(console.log("Initializing marker"),a.current=new F({source:new P({features:[new V({geometry:new Q([0,0]),name:"Point"})]})}),a.current.setStyle(new G({image:new n1({fill:new t1({color:"#000000"}),stroke:new q({color:"#ff0000",width:2}),radius:3})})),t.current.addLayer(a.current)),()=>{var h;(h=a.current)==null||h.dispose(),a.current=void 0}),[t.current]),u.exports.useEffect(()=>{if(a.current&&t.current&&n){const h=o.datapoints[n];Z(h)}},[n]),e1(()=>{var g,p;if(t.current||!s.current)return;console.info("Initializing map");const h=o.datapoints[0];t.current=new s1({target:s.current,layers:[new i1({source:new a1({url:"https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",maxZoom:19,attributions:"ArcGIS"})})],view:new r1({center:b([h.lon,h.lat]),zoom:14})});var d=[new G({stroke:new q({color:"#d12710",width:2})})],r=new F({source:new P({features:o.datapoints.map((f,y)=>{let x=o.datapoints[y+1];x||(x=f);var c=b([f.lon,f.lat]),v=b([x.lon,x.lat]);const M=new V({geometry:new o1([c,v]),name:"Line"});return M.setId(y),M})})});r.setStyle(d),t.current.addLayer(r);const i=(g=r.getSource())==null?void 0:g.getExtent();i&&t.current.getView().fit(i,{padding:[50,50,50,50]});const l=f=>{var y;f.dragging||(y=t.current)==null||y.forEachFeatureAtPixel(f.pixel,(x,c)=>{if(!c)return!0;const v=x.getId();if(typeof v=="number"){const M=o.datapoints[v];return Z(M),!!M}},{hitTolerance:10,layerFilter:x=>x===r})};return t.current.on("pointermove",l),(p=t.current)==null||p.on("singleclick",l),e(),()=>{var f;(f=t.current)==null||f.dispose(),t.current=void 0}}),m("div",{style:{width:"100%",height:"100%"},ref:s})});var D=(o=>(o[o.Metric=0]="Metric",o[o.Imperial=1]="Imperial",o))(D||{});const E1="_Chart_1q3ui_1";var L1={Chart:E1};function b1(o){return o*3.28084}function R1(o){return o*3.6}function C1(o){return o*.6213711922}function I1(o,n){return o===D.Imperial?b1(n):n}function B(o,n){return n=R1(n),o===D.Imperial?C1(n):n}S.register(T1,Z1,l1,c1,h1,d1,u1,m1);S.defaults.elements.line.borderWidth=1;S.defaults.elements.point.pointStyle="line";S.defaults.elements.point.radius=0;S.defaults.elements.point.borderWidth=0;S.defaults.elements.point.hoverBorderWidth=1;S.defaults.elements.point.rotation=90;S.defaults.elements.point.hoverRadius=1e3;S.defaults.elements.point.hoverBorderColor="#000000";S.defaults.elements.point.backgroundColor="rgba(0, 0, 0, 0)";S.defaults.elements.point.borderColor="rgba(0, 0, 0, 0)";const N1=({track:o,unit:n,setActiveDatapointIndex:e})=>{const s=` (${n===D.Imperial?"ft":"m"})`,t=` (${n===D.Imperial?"mph":"km/h"})`,a=u.exports.useMemo(()=>o.datapoints.map((c,v)=>({x:v,y:I1(n,c.elevation)})),[n,o.datapoints]),Z=u.exports.useMemo(()=>o.datapoints.map((c,v)=>({x:v,y:B(n,c.horizontalSpeed)})),[n,o.datapoints]),h=u.exports.useMemo(()=>o.datapoints.map((c,v)=>({x:v,y:B(n,c.verticalSpeed)})),[n,o.datapoints]),d=u.exports.useMemo(()=>o.datapoints.map((c,v)=>({x:v,y:c.glideRatio})),[o.datapoints]),r=u.exports.useMemo(()=>Math.max(...a.map(c=>c.y)),[a]),i=u.exports.useMemo(()=>Math.floor(Math.min(Math.min(...Z.map(c=>c.y)),Math.min(...h.map(c=>c.y)))),[Z,h]),l=u.exports.useMemo(()=>Math.ceil(Math.max(Math.max(...Z.map(c=>c.y)),Math.max(...h.map(c=>c.y)))),[Z,h]),g=u.exports.useMemo(()=>Math.floor(Math.min(...d.map(c=>c.y))),[d]),p=u.exports.useMemo(()=>Math.ceil(Math.max(...d.map(c=>c.y))),[d]),f=u.exports.useMemo(()=>({labels:o.datapoints.map((c,v)=>v),datasets:[{label:"Elevation",data:a,borderColor:"#000000",backgroundColor:"#000000",yAxisID:"y"},{label:"Horizontal Speed",data:Z,borderColor:"#ff0000",backgroundColor:"#ff0000",yAxisID:"y1"},{label:"Vertical Speed",data:h,borderColor:"#00ff00",backgroundColor:"#00ff00",yAxisID:"y2"},{label:"Glide Ratio",data:d,borderColor:"#0000ff",backgroundColor:"#0000ff",yAxisID:"y3"}]}),[a,Z,h,d]),y=u.exports.useMemo(()=>({responsive:!0,maintainAspectRatio:!1,parsing:!1,normalized:!0,interaction:{mode:"index",intersect:!1},animation:!1,plugins:{decimation:{enabled:!0,algorithm:"min-max"},zoom:{limits:{x:{minRange:10}},pan:{enabled:!0,mode:"x"},zoom:{wheel:{enabled:!0},pinch:{enabled:!0},mode:"x",drag:{enabled:!0,modifierKey:"shift"}}}},scales:{y:{type:"linear",display:!0,position:"right",title:{display:!0,text:"Elevation"+s,color:"#000000"},min:0,max:r},y1:{type:"linear",display:!0,position:"left",title:{display:!0,text:"Horizontal Speed"+t,color:"#ff0000"},min:i,max:l,grid:{drawOnChartArea:!1}},y2:{type:"linear",display:!0,position:"left",title:{display:!0,text:"Vertical Speed"+t,color:"#00ff00"},min:i,max:l,grid:{drawOnChartArea:!1}},y3:{type:"linear",display:!0,position:"left",title:{display:!0,text:"Glide Ratio",color:"#0000ff"},min:g,max:p,grid:{drawOnChartArea:!1}}}}),[r,i,l,g,p]),x=u.exports.useMemo(()=>[{id:"myEventCatcher",beforeEvent(c,v,M){const L=v.event;if(L.type==="mouseout"&&e(null),L.type==="mousemove"&&L.x){const X=c.canvas.getBoundingClientRect();var C=L.x-X.left;C>c.chartArea.right&&(C=c.chartArea.right);const I=c.scales.x.getValueForPixel(C);e(I!=null?I:null)}}}],[]);return m("div",{className:L1.Chart,children:m(g1,{height:300,data:f,options:y,plugins:x})})},_1="_App_1tt6o_1",z1="_ChartMap_1tt6o_5";var W={App:_1,ChartMap:z1};const F1="_Load_jxcta_1",P1="_Dialog_jxcta_11",V1="_UnitSelect_jxcta_18",G1="_DropArea_jxcta_25",q1="_DialogTitle_jxcta_38";var w={Load:F1,Dialog:P1,UnitSelect:V1,DropArea:G1,DialogTitle:q1},j1=`time,lat,lon,hMSL,velN,velE,velD,hAcc,vAcc,sAcc,gpsFix,numSV
...
2010-09-11T21:25:09.00Z,53.6297011,-114.1799852,1868.334,-20.36,4.76,9.92,1.247,1.935,0.54,3,13`;const k1=z(({onLoad:o,setUnit:n})=>{const e=u.exports.useRef(null);return E("div",{className:w.Load,children:[m($,{children:m("meta",{name:"theme-color",content:"#f0fbff"})}),E("div",{className:w.Dialog,children:[m("div",{className:w.DialogTitle,children:"Load FlySight CSV"}),E("div",{className:w.UnitSelect,children:[m("label",{htmlFor:"input-unit",children:"Units"}),E("select",{id:"input-unit",onChange:s=>n(s.target.value),children:[m("option",{value:D.Imperial,children:"Imperial (mph)"}),m("option",{value:D.Metric,children:"Metric (km/h)"})]})]}),E("div",{className:w.DropArea,onClick:s=>{var t;(t=e.current)==null||t.click()},children:[m("div",{children:"Press to select file"}),m("input",{style:{display:"none"},ref:e,type:"file",accept:".csv",className:w.FileInput,onChange:async s=>{var a;const t=(a=s.target.files)==null?void 0:a[0];if(t){const Z=await t.text();o(Z)}}})]}),m("a",{href:"#",className:w.Link,onClick:s=>{s.preventDefault(),o(j1)},children:"Load Sample"})]})]})}),O1=f1(z(()=>{const o=U(),n=u.exports.useRef(),[e,s]=u.exports.useState(null),[t,a]=u.exports.useState(null),[Z,h]=u.exports.useState(D.Imperial);return u.exports.useEffect(()=>{if(n.current||!t)return;const d=new D1;return d.importFromText(t),n.current=d,o(),()=>{n.current=void 0}},[t]),m("div",{className:W.App,children:n.current?E("div",{className:W.ChartMap,children:[m($,{children:m("meta",{name:"theme-color",content:"#fff"})}),m(N1,{track:n.current,unit:Z,setActiveDatapointIndex:d=>s(d)}),m(w1,{track:n.current,activeDatapointIndex:e})]}):m(k1,{onLoad:d=>{n.current=void 0,a(d)},setUnit:h})})}),{showDialog:!0});p1({dsn:"https://975c9c3321074313ab41c1380cbf4c3c@o1200738.ingest.sentry.io/6324846",integrations:[new v1],tracesSampleRate:1});const H=document.getElementById("root");if(!H)throw new Error("Missing root element!");y1.render(m(x1.StrictMode,{children:m(S1,{children:m(O1,{})})}),H);
//# sourceMappingURL=index.42ac680f.js.map
