var X=Object.defineProperty;var H=(l,n,e)=>n in l?X(l,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[n]=e;var T=(l,n,e)=>(H(l,typeof n!="symbol"?n+"":n,e),e);import{g as C,P as U,w as _,u as k,r as u,L as z,S as I,O as F,G as Y,a as P,b as K,c as J,d as V,e as Q,j as g,f as E,h as n1,i as t1,k as e1,l as s1,m as i1,C as x,p as a1,n as r1,o as o1,q as T1,s as Z1,t as l1,v as c1,x as h1,y as d1,z as D,W as B,A as u1,B as m1,D as g1,R as f1,E as v1,F as p1}from"./vendor.8bccba7c.js";const y1=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const Z of a.addedNodes)Z.tagName==="LINK"&&Z.rel==="modulepreload"&&s(Z)}).observe(document,{childList:!0,subtree:!0});function e(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerpolicy&&(a.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?a.credentials="include":t.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(t){if(t.ep)return;t.ep=!0;const a=e(t);fetch(t.href,a)}};y1();const L=9.80665,x1=101325,N=.0065,G=288.15,q=.0289644,j=8.31447;class M{constructor(n){T(this,"dateTime");T(this,"hasGeodetic");T(this,"lat");T(this,"lon");T(this,"hMSL");T(this,"velN");T(this,"velE");T(this,"velD");T(this,"hAcc");T(this,"vAcc");T(this,"sAcc");T(this,"heading");T(this,"cAcc");T(this,"numSV");T(this,"t");T(this,"x");T(this,"y");T(this,"z");T(this,"dist2D");T(this,"dist3D");T(this,"curv");T(this,"accel");T(this,"ax");T(this,"ay");T(this,"az");T(this,"amag");T(this,"lift");T(this,"drag");T(this,"vx");T(this,"vy");T(this,"theta");T(this,"omega");this.raw=n,this.raw&&(this.hasGeodetic=!0,this.dateTime=new Date(this.raw.time),this.lat=parseFloat(this.raw.lat),this.lon=parseFloat(this.raw.lon),this.hMSL=parseFloat(this.raw.hMSL),this.velN=parseFloat(this.raw.velN),this.velE=parseFloat(this.raw.velE),this.velD=parseFloat(this.raw.velD),this.hAcc=parseFloat(this.raw.hAcc),this.vAcc=parseFloat(this.raw.vAcc),this.sAcc=parseFloat(this.raw.sAcc),this.numSV=parseInt(this.raw.numSV,10))}get elevation(){return this.z}get northSpeed(){return this.vy}get eastSpeed(){return this.vx}get northSpeedRaw(){return this.velN}get eastSpeedRaw(){return this.velE}get verticalSpeed(){return this.velD}get horizontalSpeed(){return Math.sqrt(this.vx*this.vx+this.vy*this.vy)}get totalSpeed(){return Math.sqrt(this.vx*this.vx+this.vy*this.vy+this.velD*this.velD)}get diveAngle(){return Math.atan2(this.velD,Math.sqrt(this.vx*this.vx+this.vy*this.vy))/Math.PI*180}get curvature(){return this.curv}get glideRatio(){return this.velD!=0?Math.sqrt(this.vx*this.vx+this.vy*this.vy)/this.velD:0}get horizontalAccuracy(){return this.hAcc}get verticalAccuracy(){return this.vAcc}get speedAccuracy(){return this.sAcc}get numberOfSatellites(){return this.numSV}get time(){return this.t}get distance2D(){return this.dist2D}get distance3D(){return this.dist3D}get acceleration(){return this.accel}get accForward(){return this.ax}get accRight(){return this.ay}get accDown(){return this.az}get accMagnitude(){return this.amag}get totalEnergy(){const n=this.totalSpeed;return n*n/2+L*this.elevation}get energyRate(){return this.totalSpeed*this.acceleration-L*this.verticalSpeed}get liftCoefficient(){return this.lift}get dragCoefficient(){return this.drag}get course(){return this.theta}get courseRate(){return this.omega}get courseAccuracy(){return this.cAcc}static interpolate(n,e,s){const t=new M,a=n.dateTime.getTime(),Z=e.dateTime.getTime();return t.dateTime=new Date,t.dateTime.setTime(a+s*(Z-a)),t.hasGeodetic=n.hasGeodetic&&e.hasGeodetic,t.lat=n.lat+s*(e.lat-n.lat),t.lon=n.lon+s*(e.lon-n.lon),t.hMSL=n.hMSL+s*(e.hMSL-n.hMSL),t.velN=n.velN+s*(e.velN-n.velN),t.velE=n.velE+s*(e.velE-n.velE),t.velD=n.velD+s*(e.velD-n.velD),t.hAcc=n.hAcc+s*(e.hAcc-n.hAcc),t.vAcc=n.vAcc+s*(e.vAcc-n.vAcc),t.sAcc=n.sAcc+s*(e.sAcc-n.sAcc),s<.5?t.numSV=n.numSV:t.numSV=e.numSV,t.t=n.t+s*(e.t-n.t),t.x=n.x+s*(e.x-n.x),t.y=n.y+s*(e.y-n.y),t.z=n.z+s*(e.z-n.z),t.dist2D=n.dist2D+s*(e.dist2D-n.dist2D),t.dist3D=n.dist3D+s*(e.dist3D-n.dist3D),t.curv=n.curv+s*(e.curv-n.curv),t.accel=n.accel+s*(e.accel-n.accel),t.ax=n.ax+s*(e.ax-n.ax),t.ay=n.ay+s*(e.ay-n.ay),t.az=n.az+s*(e.az-n.az),t.amag=n.amag+s*(e.amag-n.amag),t.lift=n.lift+s*(e.lift-n.lift),t.drag=n.drag+s*(e.drag-n.drag),t.heading=n.heading+s*(e.heading-n.heading),t.cAcc=n.cAcc+s*(e.cAcc-n.cAcc),t.vx=n.vx+s*(e.vx-n.vx),t.vy=n.vy+s*(e.vy-n.vy),t.theta=n.theta+s*(e.theta-n.theta),t.omega=n.omega+s*(e.omega-n.omega),t}static getDistance(n,e,s){if(!s&&n.hasGeodetic&&e.hasGeodetic)return C([n.lat,n.lon],[e.lat,e.lon]);{const t=e.x-n.x,a=e.y-n.y;return Math.sqrt(t*t+a*a)}}static getBearing(n,e,s){if(!s&&n.hasGeodetic&&e.hasGeodetic){const t=C([n.lat,0],[e.lat,0]);return C([0,n.lon],[0,e.lon]),t/180*Math.PI}else{const t=e.x-n.x,a=e.y-n.y;return Math.atan2(t,a)}}}class S1{constructor(){T(this,"options",{groundReference:0,fixedReference:0,windAdjustment:!1,windE:0,windN:0,mass:90,planformArea:2});T(this,"wind");T(this,"ground");T(this,"course");T(this,"datapoints",[])}importFromText(n){U.parse(n,{header:!0,skipEmptyLines:!0}).data.forEach(s=>{!s.time||this.datapoints.push(new M(s))}),this.initTime(),this.initAltitude(),this.initAcceleration(),this.updateVelocity(!0),console.log("Track:",this)}initTime(){const n=this.datapoints[0].dateTime.getTime();this.datapoints.forEach((e,s)=>{const t=e.dateTime.getTime();e.t=(t-n)/1e3})}initExit(){}initAltitude(){let n;this.ground?n=this.ground:this.options.groundReference===0?n=this.datapoints[this.datapoints.length-1].hMSL:n=this.options.fixedReference,this.ground=n,this.datapoints.forEach((e,s)=>{e.z=e.hMSL-n})}initAcceleration(){this.datapoints.forEach((n,e)=>{const s=this.getSlope(e,n.northSpeedRaw),t=this.getSlope(e,n.eastSpeedRaw),a=this.getSlope(e,n.verticalSpeed),Z=Math.sqrt(n.velN*n.velN+n.velE*n.velE);n.ax=(s*n.velN+t*n.velE)/Z,n.ay=(t*n.velN-s*n.velE)/Z,n.az=a,n.amag=Math.sqrt(s*s+t*t+a*a)})}initAerodynamics(){this.datapoints.forEach((n,e)=>{let s=this.getSlope(e,n.northSpeed),t=this.getSlope(e,n.eastSpeed),a=this.getSlope(e,n.verticalSpeed);a-=L;const Z=n.totalSpeed,h=(s*n.vy+t*n.vx+a*n.velD)/Z,d=h*n.vy/Z,r=h*n.vx/Z,i=h*n.velD/Z,c=Math.sqrt(d*d+r*r+i*i),f=s-d,p=t-r,v=a-i,o=Math.sqrt(f*f+p*p+v*v),m=x1*Math.pow(1-N*n.hMSL/G,L*q/j/N),w=G-N*n.hMSL,y=m/(j/q)/w*Z*Z/2;n.lift=this.options.mass*o/y/this.options.planformArea,n.drag=this.options.mass*c/y/this.options.planformArea})}updateVelocity(n=!1){if(this.datapoints.length===0)return;const e=this.getWind();if(n&&(this.wind=e),this.options.windAdjustment){for(let r=0;r<this.datapoints.length;++r){const i=this.interpolateDataT(0),c=this.datapoints[r],f=M.getDistance(i,c,this.options.windAdjustment),p=M.getBearing(i,c,this.options.windAdjustment);c.x=f*Math.sin(p)-e.east*c.t,c.y=f*Math.cos(p)-e.north*c.t}for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.vx=i.velE-e.east,i.vy=i.velN-e.north}}else{for(let r=0;r<this.datapoints.length;++r){const i=this.interpolateDataT(0),c=this.datapoints[r],f=M.getDistance(i,c,this.options.windAdjustment),p=M.getBearing(i,c,this.options.windAdjustment);c.x=f*Math.sin(p),c.y=f*Math.cos(p)}for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.vx=i.velE,i.vy=i.velN}}let s=0,t=0;for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];if(r>0){const c=this.datapoints[r-1],f=i.x-c.x,p=i.y-c.y,v=Math.sqrt(f*f+p*p),o=i.hMSL-c.hMSL;s+=v,t+=Math.sqrt(v*v+o*o)}i.dist2D=s,i.dist3D=t}const a=this.interpolateDataT(0);for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.x-=a.x,i.y-=a.y,i.dist2D-=a.dist2D,i.dist3D-=a.dist3D}let Z;this.course?Z=this.course:Z=0,n&&(this.course=Z);let h=0,d=!0;for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.heading=Math.atan2(i.vx,i.vy)/Math.PI*180;const c=i.totalSpeed;if(c!=0?i.cAcc=i.sAcc/c:i.cAcc=0,!d){for(;i.heading<h-180;)i.heading+=360;for(;i.heading>=h+180;)i.heading-=360}i.theta=i.heading-Z,d=!1,h=i.heading}for(let r=0;r<this.datapoints.length;++r){const i=this.datapoints[r];i.curv=this.getSlope(r,i.diveAngle),i.accel=this.getSlope(r,i.totalSpeed),i.omega=this.getSlope(r,i.course)}this.initAerodynamics()}getSlope(n,e){const s=Math.max(0,n-4),t=Math.min(this.datapoints.length-1,n+4);let a=0,Z=0,h=0,d=0;for(let i=s;i<=t;++i){const c=this.datapoints[i],f=e;a+=c.t,Z+=f,h+=c.t*c.t,d+=c.t*f}const r=t-s+1;return(d-a*Z/r)/(h-a*a/r)}getWind(){return this.wind?this.wind:{east:this.options.windE,north:this.options.windN}}getWindSpeedDirection(){const n=this.getWind(),e=Math.sqrt(n.east*n.east+n.north*n.north);let s=Math.atan2(-n.east,-n.north)/Math.PI;return s<0&&(s+=360),{speed:e,direction:s}}interpolateDataT(n){const e=this.findIndexBelowT(n),s=this.findIndexAboveT(n);if(e<0)return this.datapoints[0];if(s>=this.datapoints.length)return this.datapoints[this.datapoints.length-1];{const t=this.datapoints[e],a=this.datapoints[s];return M.interpolate(t,a,(n-t.t)/(a.t-t.t))}}findIndexBelowT(n){let e=-1,s=this.datapoints.length;for(;e+1!==s;){const t=Math.floor((e+s)/2);this.datapoints[t].t<n?e=t:s=t}return e}findIndexAboveT(n){let e=-1,s=this.datapoints.length;for(;e+1!==s;){const t=Math.ceil((e+s)/2);this.datapoints[t].t>n?s=t:e=t}return s}}const M1=_(({track:l,activeDatapointIndex:n})=>{const e=k(),s=u.exports.useRef(null),t=u.exports.useRef(),a=u.exports.useRef();function Z(h){var d,r;(r=(d=a.current)==null?void 0:d.getSource())==null||r.forEachFeature(i=>{const c=h?E([h.lon,h.lat]):[0,0];i.getGeometry().setCoordinates(c)})}return u.exports.useEffect(()=>(!a.current&&t.current&&(console.log("Initializing marker"),a.current=new z({source:new I({features:[new F({geometry:new Y([0,0]),name:"Point"})]})}),a.current.setStyle(new P({image:new K({fill:new J({color:"#000000"}),stroke:new V({color:"#ff0000",width:2}),radius:3})})),t.current.addLayer(a.current)),()=>{var h;(h=a.current)==null||h.dispose(),a.current=void 0}),[t.current]),u.exports.useEffect(()=>{if(a.current&&t.current&&n){const h=l.datapoints[n];Z(h)}},[n]),Q(()=>{var f,p;if(t.current||!s.current)return;console.info("Initializing map");const h=l.datapoints[0];t.current=new n1({target:s.current,layers:[new t1({source:new e1({url:"https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",maxZoom:19,attributions:"ArcGIS"})})],view:new s1({center:E([h.lon,h.lat]),zoom:14})});var d=[new P({stroke:new V({color:"#d12710",width:2})})],r=new z({source:new I({features:l.datapoints.map((v,o)=>{let m=l.datapoints[o+1];m||(m=v);var w=E([v.lon,v.lat]),S=E([m.lon,m.lat]);const y=new F({geometry:new i1([w,S]),name:"Line"});return y.setId(o),y})})});r.setStyle(d),t.current.addLayer(r);const i=(f=r.getSource())==null?void 0:f.getExtent();i&&t.current.getView().fit(i,{padding:[50,50,50,50]});const c=v=>{var o;v.dragging||(o=t.current)==null||o.forEachFeatureAtPixel(v.pixel,(m,w)=>{if(!w)return!0;const S=m.getId();if(typeof S=="number"){const y=l.datapoints[S];return Z(y),!!y}},{hitTolerance:10,layerFilter:m=>m===r})};return t.current.on("pointermove",c),(p=t.current)==null||p.on("singleclick",c),e(),()=>{var v;(v=t.current)==null||v.dispose(),t.current=void 0}}),g("div",{style:{width:"100%",height:"100%"},ref:s})});var b=(l=>(l[l.Metric=0]="Metric",l[l.Imperial=1]="Imperial",l))(b||{});const A1="_Chart_1q3ui_1";var w1={Chart:A1};x.register(a1,r1,o1,T1,Z1,l1,c1,h1);x.defaults.elements.line.borderWidth=1;x.defaults.elements.point.pointStyle="line";x.defaults.elements.point.radius=0;x.defaults.elements.point.borderWidth=0;x.defaults.elements.point.hoverBorderWidth=1;x.defaults.elements.point.rotation=90;x.defaults.elements.point.hoverRadius=1e3;x.defaults.elements.point.hoverBorderColor="#000000";x.defaults.elements.point.backgroundColor="rgba(0, 0, 0, 0)";x.defaults.elements.point.borderColor="rgba(0, 0, 0, 0)";const D1=({track:l,unit:n,setActiveDatapointIndex:e})=>{u.exports.useRef({lastX:-1});const s=u.exports.useMemo(()=>l.datapoints.map((o,m)=>({x:m,y:o.elevation})),[n,l.datapoints]),t=u.exports.useMemo(()=>l.datapoints.map((o,m)=>({x:m,y:o.horizontalSpeed})),[n,l.datapoints]),a=u.exports.useMemo(()=>l.datapoints.map((o,m)=>({x:m,y:o.verticalSpeed})),[n,l.datapoints]),Z=u.exports.useMemo(()=>l.datapoints.map((o,m)=>({x:m,y:o.glideRatio})),[l.datapoints]),h=u.exports.useMemo(()=>Math.max(...s.map(o=>o.y)),[s]),d=u.exports.useMemo(()=>Math.floor(Math.min(Math.min(...t.map(o=>o.y)),Math.min(...a.map(o=>o.y)))),[t,a]),r=u.exports.useMemo(()=>Math.ceil(Math.max(Math.max(...t.map(o=>o.y)),Math.max(...a.map(o=>o.y)))),[t,a]),i=u.exports.useMemo(()=>Math.floor(Math.min(...Z.map(o=>o.y))),[Z]),c=u.exports.useMemo(()=>Math.ceil(Math.max(...Z.map(o=>o.y))),[Z]),f=u.exports.useMemo(()=>({labels:l.datapoints.map((o,m)=>m),datasets:[{label:"Elevation",data:s,borderColor:"#000000",backgroundColor:"#000000",yAxisID:"y"},{label:"Horizontal Speed",data:t,borderColor:"#ff0000",backgroundColor:"#ff0000",yAxisID:"y1"},{label:"Vertical Speed",data:a,borderColor:"#00ff00",backgroundColor:"#00ff00",yAxisID:"y2"},{label:"Glide Ratio",data:Z,borderColor:"#0000ff",backgroundColor:"#0000ff",yAxisID:"y3"}]}),[s,t,a,Z]),p=u.exports.useMemo(()=>({responsive:!0,maintainAspectRatio:!1,parsing:!1,normalized:!0,interaction:{mode:"index",intersect:!1},animation:!1,plugins:{decimation:{enabled:!0,algorithm:"min-max"},zoom:{limits:{x:{minRange:10}},pan:{enabled:!0,mode:"x"},zoom:{wheel:{enabled:!0},pinch:{enabled:!0},mode:"x",drag:{enabled:!0,modifierKey:"shift"}}}},scales:{y:{type:"linear",display:!0,position:"right",title:{display:!0,text:"Elevation",color:"#000000"},min:0,max:h},y1:{type:"linear",display:!0,position:"left",title:{display:!0,text:"Horizontal Speed",color:"#ff0000"},min:d,max:r,grid:{drawOnChartArea:!1}},y2:{type:"linear",display:!0,position:"left",title:{display:!0,text:"Vertical Speed",color:"#00ff00"},min:d,max:r,grid:{drawOnChartArea:!1}},y3:{type:"linear",display:!0,position:"left",title:{display:!0,text:"Glide Ratio",color:"#0000ff"},min:i,max:c,grid:{drawOnChartArea:!1}}}}),[h,d,r,i,c]),v=u.exports.useMemo(()=>[{id:"myEventCatcher",beforeEvent(o,m,w){const S=m.event;if(S.type==="mouseout"&&e(null),S.type==="mousemove"&&S.x){const $=o.canvas.getBoundingClientRect();var y=S.x-$.left;y>o.chartArea.right&&(y=o.chartArea.right);const R=o.scales.x.getValueForPixel(y);e(R!=null?R:null)}}}],[]);return g("div",{className:w1.Chart,children:g(d1,{height:300,data:f,options:p,plugins:v})})},E1="_App_1tt6o_1",L1="_ChartMap_1tt6o_5";var O={App:E1,ChartMap:L1};const b1="_Load_jxcta_1",R1="_Dialog_jxcta_11",C1="_UnitSelect_jxcta_18",N1="_DropArea_jxcta_25",_1="_DialogTitle_jxcta_38";var A={Load:b1,Dialog:R1,UnitSelect:C1,DropArea:N1,DialogTitle:_1},z1=`time,lat,lon,hMSL,velN,velE,velD,hAcc,vAcc,sAcc,gpsFix,numSV
...
2010-09-11T21:25:09.00Z,53.6297011,-114.1799852,1868.334,-20.36,4.76,9.92,1.247,1.935,0.54,3,13`;const I1=_(({onLoad:l,setUnit:n})=>{const e=u.exports.useRef(null);return D("div",{className:A.Load,children:[g(B,{children:g("meta",{name:"theme-color",content:"#f0fbff"})}),D("div",{className:A.Dialog,children:[g("div",{className:A.DialogTitle,children:"Load FlySight CSV"}),D("div",{className:A.UnitSelect,children:[g("label",{htmlFor:"input-unit",children:"Units"}),D("select",{id:"input-unit",onChange:s=>n(s.target.value),children:[g("option",{value:b.Imperial,children:"Imperial (mph)"}),g("option",{value:b.Metric,children:"Metric (km/h)"})]})]}),D("div",{className:A.DropArea,onClick:s=>{var t;(t=e.current)==null||t.click()},children:[g("div",{children:"Press to select file"}),g("input",{style:{display:"none"},ref:e,type:"file",accept:".csv",className:A.FileInput,onChange:async s=>{var a;const t=(a=s.target.files)==null?void 0:a[0];if(t){const Z=await t.text();l(Z)}}})]}),g("a",{href:"#",className:A.Link,onClick:s=>{s.preventDefault(),l(z1)},children:"Load Sample"})]})]})}),F1=u1(_(()=>{const l=k(),n=u.exports.useRef(),[e,s]=u.exports.useState(null),[t,a]=u.exports.useState(null),[Z,h]=u.exports.useState(b.Imperial);return u.exports.useEffect(()=>{if(n.current||!t)return;const d=new S1;return d.importFromText(t),n.current=d,l(),()=>{n.current=void 0}},[t]),g("div",{className:O.App,children:n.current?D("div",{className:O.ChartMap,children:[g(B,{children:g("meta",{name:"theme-color",content:"#fff"})}),g(D1,{track:n.current,unit:Z,setActiveDatapointIndex:d=>s(d)}),g(M1,{track:n.current,activeDatapointIndex:e})]}):g(I1,{onLoad:d=>{n.current=void 0,a(d)},setUnit:h})})}),{showDialog:!0});m1({dsn:"https://975c9c3321074313ab41c1380cbf4c3c@o1200738.ingest.sentry.io/6324846",integrations:[new g1],tracesSampleRate:1});const W=document.getElementById("root");if(!W)throw new Error("Missing root element!");f1.render(g(v1.StrictMode,{children:g(p1,{children:g(F1,{})})}),W);
//# sourceMappingURL=index.c0c6010b.js.map
